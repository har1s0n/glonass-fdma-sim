...
void Service::registerRoutes() {
   ...
   // страницы к модели идут к точкам /v1/* того же источника, поэтому ни каталог статики, ни
   // заголовки междоменных запросов не требуются. Подписка компоновки «Приёмник» на WebSocket
   // внешнего приёмника идёт мимо сервиса: приёмный тракт в его границы не входит.
