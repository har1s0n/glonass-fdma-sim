...
constexpr std::int64_t carrierFreqL1OC    = 1600995000;       // f_L1OC = 1565·f_b, Гц (поз.26; [ИКД-L1OC] 2.1.1)
constexpr std::int64_t chipRateL1OC       = 1023000;          // f_T1, чип/с (поз.27; [ИКД-L1OC] 2.1.2)
constexpr std::int64_t modelBandwidthL1OC = 2 * chipRateL1OC; // B_model = 2·f_T1 = 2,046 МГц — односторонняя
// полоса модели L1OC, главный лепесток по первым нулям (поз.34; В.2)
